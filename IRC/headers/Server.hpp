...
/*   Updated: 2024/03/15 23:28:18 by mbachar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define RPL_MYINFO(nick, hostname)											":" + std::string(hostname) + " 004 " + nick + " :Host: " + std::string(hostname) + ", Version: 1.1 !\r\n"
# define RPL_HELP(nick, hostname)													":" + std::string(hostname) + " 005 " + nick + " :Use (HELP) for more commands !\r\n"
